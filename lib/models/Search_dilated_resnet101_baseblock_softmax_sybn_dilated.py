...
class ALLSearch_SE(nn.Module):
    def __init__(self, n_classes , dilation, input_channels = 3 ):
        super().__init__()
        ...
        self.resnet = build_backbone('dilated_resnet',output_stride = 32,BatchNorm = SynchronizedBatchNorm2d)
...
def get_seg_model(cfg, **kwargs):
    ...
    model = ALLSearch_SE(n_classes = cfg.DATASET.NUM_CLASSES, dilation = cfg.MODEL.DILATION)

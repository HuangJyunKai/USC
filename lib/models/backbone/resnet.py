...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, BatchNorm, pretrained=True):
        self.inplanes = 64
...
def ResNet101(BatchNorm, pretrained=True):
    """Constructs a ResNet-101 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], BatchNorm, pretrained=pretrained)
    return model
